...
public class TestSinglyLinkedList {
   public static void main(String[] args) {
      ...
      /*Criação da lista de Points*/
      SinglyLinkedList<Point> lista_points = new SinglyLinkedList<Point>();

      /*Escrever a lista no inicio (vazia)*/
      System.out.println(lista_points);

      /*Verificar se a lista está vazia*/
      System.out.println("isEmpty? " + lista_points.isEmpty()); 

      /* Adicionando numeros de 1 a 5 ao final da lista*/
      for (int i=1; i<=2; i++){
         for(int j = 1; j<=2;j++){
            Point p = new Point(i,j);
            lista_points.addLast(p);
         }
      }
      System.out.println(lista_points);
