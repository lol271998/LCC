...
public class BTree<T> {   
   ...
   //ED207 - Nós profundos.
   // Percorrer a arvore até chegar a k
   ...
   private int nodesLevel(BTNode<T> n, int k, int nc){
      
      // Verifica se o nó chamado é null, nesse caso soma 0
      if(n == null || nc>k){
         System.out.println("nó: " + n);
         System.out.println("nivel actual: " + nc);
         System.out.println("k: " + k);
         return 0;
      }

      // Se não for null, e for o nó pretendido soma 1
      if(nc == k){
         System.out.println("nó: " + n);
         System.out.println("nivel actual: " + nc);
         System.out.println("k: " + k);
      ...
      return nodesLevel(n.getLeft(),k,nc+1) + nodesLevel(n.getRight(),k,nc+1);
      // Passa para o nó seguinte, se for igual a k e existir, soma um;
   }
