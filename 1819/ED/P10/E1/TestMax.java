...
public class TestMax {
   ...
   //Calcula recursivamente a soma do array
   ...
   //Divide o array em dois e soma as duas partes
   ...
   public static void main(String[] args) {
      ...
      System.out.println("Soma1: " + sumRec1(v,0,v.length-1));
      System.out.println("Soma2: " + sumRec2(v,0,v.length-1));
   }
