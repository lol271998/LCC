...
public class Strings {
	...
	// String a = 1007;     // A tentar atribuir um número inteiro a uma String (Não é Possivel)
	String b = "abc";   // Colocar "1007" na variável b
	...
	/*System.out.println("charAt(10) = " + d.charAt(10)); Out of range porque a string só tem 3 entradas*/
	...
	System.out.println(b.toUpperCase()); //Para por para maiúscula a string
    }
} 
